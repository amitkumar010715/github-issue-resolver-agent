...
Use the repository context, changed files, diff, implementation notes, and verification output. Keep the audit scoped to changed behavior unless the user asks for a broader review.
